...
<section class="py-5">
        ...
        <div class="row g-4">
            @php
                $produkList = [
                    ...
                    ['judul' => 'Hot Matcha', 'harga' => 23000, 'gambar' => 'Hot Matchaa.jpeg', 'deskripsi' => 'Hangatnya matcha murni, pas untuk menemani waktu santaimu.'],
                    ['judul' => 'Milk Matcha', 'harga' => 26000, 'gambar' => 'Milk Matcha.jpg', 'deskripsi' => 'Matcha dicampur milk yang creamy dan ringan.'],
                    ['judul' => 'Matcha Choco', 'harga' => 27000, 'gambar' => 'Matcha Choco.jpg', 'deskripsi' => 'Perpaduan matcha dan cokelat, manis dan creamy di lidah.'],
                    ['judul' => 'Matcha Cream', 'harga' => 29000, 'gambar' => 'Matcha Cream.jpg', 'deskripsi' => 'Matcha dengan topping whipped cream lembut di atasnya.'],
                    ['judul' => 'Matcha Float', 'harga' => 30000, 'gambar' => 'Matcha Float.jpg', 'deskripsi' => 'Matcha segar dengan topping ice cream vanilla lembut.'],
                ];
            @endphp
    ...
    <div class="card border-0 shadow-sm h-100 product-card rounded-4 overflow-hidden">
        <div class="ratio ratio-1x1" style="max-height: 200px; overflow: hidden;">
            <img src="{{ asset('storage/image/' . $produk['gambar']) }}" 
                 class="card-img-top" 
                 alt="{{ $produk['judul'] }}" 
