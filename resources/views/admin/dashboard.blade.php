...
<div class="container py-5">
    ...
    <div class="text-center mb-5">
        <h1 class="fw-bold display-5 text-success">🍵 Admin Dashboard</h1>
        <p class="text-muted fs-5">Kelola semua data produk, pesanan, dan pengguna dengan nyaman.</p>
    </div>
            ...
            <a href="{{ route('orders.index') }}" class="text-decoration-none">
                <div class="card shadow-sm border-0 rounded-4 bg-white h-100 hover-shadow transition py-4">
                    <div class="card-body text-center">
                        ...
                        <p class="text-muted mb-0">Pantau pesanan pelanggan dan kelola statusnya dengan cepat.</p>
                    </div>
                </div>
            </a>
        </div>
